...
export const UserOutputPaginationDtoMapper = (
  ...
  const outputModel = new UserOutputPaginationDto();

  outputModel.items = users;
  outputModel.totalCount = totalCount;
  outputModel.pageSize = pageSize;
  outputModel.page = page;
  outputModel.pagesCount = getPageCount(totalCount, pageSize);
